...
export const DENOMINATIONS: Denomination[] = [
  {
    ...
    leadership: 'A threefold ordained ministry — bishops, priests, and deacons — under the Pope. A parish is led by a priest, with deacons and lay ministers assisting; ordination is reserved to men.',
  ...
  },
  {
    ...
    leadership: 'The same threefold ordained ministry — bishops, priests, and deacons. Bishops (including patriarchs and metropolitans) govern, parish priests lead local worship, and monastic communities carry great spiritual influence.',
  ...
  },
  {
    ...
    leadership: 'Ordained pastors (ministers of Word and sacrament) lead congregations, usually with an elected church council of lay members; some bodies are led by bishops, others by district or synod presidents.',
  ...
  },
  {
    ...
    leadership: 'Rule by elders: teaching elders (pastors) and ruling elders (lay leaders) together form a “session” that governs each congregation, with deacons overseeing practical care and mercy ministry.',
  ...
  },
  {
    ...
    leadership: 'The threefold order of bishops, priests, and deacons. A diocese is led by a bishop; a local parish by a rector or vicar working alongside an elected vestry or parochial church council.',
  ...
  },
  {
    ...
    leadership: 'A pastor (or a plurality of elders) leads alongside deacons, but the gathered members hold final authority — calling pastors and deciding major matters by congregational vote.',
  ...
  },
  {
    ...
    leadership: 'A connectional system: bishops appoint pastors to churches (itinerancy), district superintendents oversee regions, and each local church is led by a pastor with lay leaders and councils; major decisions are made in conferences.',
  ...
  },
  {
    ...
    leadership: 'Commonly a senior/lead pastor with a team of elders and deacons; larger fellowships (such as the Assemblies of God) add district and general superintendents, while many churches remain fully independent.',
  ...
  },
  {
    ...
    leadership: 'Typically a lead pastor together with a board of elders, supported by deacons and ministry leaders; each church governs itself with no outside hierarchy.',
